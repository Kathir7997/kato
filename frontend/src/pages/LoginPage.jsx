...
const LoginPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen relative overflow-hidden">
      ...
      />
      {/* Dark overlay to deepen the contrast */}
      <div 
        className="absolute inset-0 z-0"
      ...
      >
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-white tracking-wide text-center" style={{ marginBottom: '32px' }}>LOG IN</h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="relative" style={{ marginBottom: '20px' }}>
              ...
              />
              {errors.email && (
                <motion.p initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="text-xs font-medium mt-1 text-center" style={{ color: '#ff6b6b' }}>
                  {errors.email}
                </motion.p>
              )}
            </div>
            ...
            <div className="flex items-center justify-between text-sm" style={{ marginBottom: '24px' }}>
              ...
              <Link to="/forgot-password" style={{ color: '#d8b4fe' }} className="hover:text-white transition-colors">
                Forgot Password?
              </Link>
            </div>
